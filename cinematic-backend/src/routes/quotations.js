...
const { createQuotation, getAllQuotations, getQuotation, updateStatus, updateQuotation, deleteQuotation, getUnreadCount, getUnreadQuotations, markAsRead, markAllAsRead, downloadQuotationPDF } = require("../controllers/quotationController");
...
router.get("/:id/pdf", auth, downloadQuotationPDF);   // Admin (download PDF)
